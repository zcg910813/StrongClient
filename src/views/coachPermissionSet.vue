<template>
  <div class="appMain">
    ...
    <div class="add-store-btn">
      <el-button class="btn-width-auto">取消</el-button>
      <el-button type="primary" class="btn-width-auto">保存修改</el-button>
    </div>
    <div>
              ...
              <div class="same-control">
                <div class='same-height' v-for='item in sanji' :key='item.id'>
                  ...
                  <div class="equal four">
                    <div >
                      <el-checkbox-group v-model='position'>
                        <el-checkbox  v-for='i in item.position' :label='i.label' :key='i.id' >{{i.label}}</el-checkbox>
                      </el-checkbox-group>
                    </div>
                  </div>
                </div>
